...
{
public:
	QIF191_EXPORT CpositiveInteger(xercesc::DOMNode* const& init);
	QIF191_EXPORT CpositiveInteger(CpositiveInteger const& init);
...
//#endif // _ALTOVA_INCLUDED_QIFDocument_ALTOVA_xs_ALTOVA_CpositiveInteger
