...
{
public:
	QIF191_EXPORT CNOTATION(xercesc::DOMNode* const& init);
	QIF191_EXPORT CNOTATION(CNOTATION const& init);
...
//#endif // _ALTOVA_INCLUDED_QIFDocument_ALTOVA_xs_ALTOVA_CNOTATION
