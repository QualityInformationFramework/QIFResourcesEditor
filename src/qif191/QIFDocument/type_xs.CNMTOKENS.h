...
{
public:
	QIF191_EXPORT CNMTOKENS(xercesc::DOMNode* const& init);
	QIF191_EXPORT CNMTOKENS(CNMTOKENS const& init);
...
//#endif // _ALTOVA_INCLUDED_QIFDocument_ALTOVA_xs_ALTOVA_CNMTOKENS
