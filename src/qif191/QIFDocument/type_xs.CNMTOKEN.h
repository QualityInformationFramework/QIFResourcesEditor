...
{
public:
	QIF191_EXPORT CNMTOKEN(xercesc::DOMNode* const& init);
	QIF191_EXPORT CNMTOKEN(CNMTOKEN const& init);
...
//#endif // _ALTOVA_INCLUDED_QIFDocument_ALTOVA_xs_ALTOVA_CNMTOKEN
