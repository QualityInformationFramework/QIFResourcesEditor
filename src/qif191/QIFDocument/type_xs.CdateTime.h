...
{
public:
	QIF191_EXPORT CdateTime(xercesc::DOMNode* const& init);
	QIF191_EXPORT CdateTime(CdateTime const& init);
...
//#endif // _ALTOVA_INCLUDED_QIFDocument_ALTOVA_xs_ALTOVA_CdateTime
