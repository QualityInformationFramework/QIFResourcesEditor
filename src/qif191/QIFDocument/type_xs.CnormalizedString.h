...
{
public:
	QIF191_EXPORT CnormalizedString(xercesc::DOMNode* const& init);
	QIF191_EXPORT CnormalizedString(CnormalizedString const& init);
...
//#endif // _ALTOVA_INCLUDED_QIFDocument_ALTOVA_xs_ALTOVA_CnormalizedString
