...
{
public:
	QIF191_EXPORT CENTITIES(xercesc::DOMNode* const& init);
	QIF191_EXPORT CENTITIES(CENTITIES const& init);
...
//#endif // _ALTOVA_INCLUDED_QIFDocument_ALTOVA_xs_ALTOVA_CENTITIES
