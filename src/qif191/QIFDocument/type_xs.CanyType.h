...
{
public:
	QIF191_EXPORT CanyType(xercesc::DOMNode* const& init);
	QIF191_EXPORT CanyType(CanyType const& init);
...
//#endif // _ALTOVA_INCLUDED_QIFDocument_ALTOVA_xs_ALTOVA_CanyType
