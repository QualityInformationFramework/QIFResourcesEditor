...
class CSecurityClassificationEnumTypeType : public TypeBase
{
public:
	QIF191_EXPORT CSecurityClassificationEnumTypeType(xercesc::DOMNode* const& init);
	QIF191_EXPORT CSecurityClassificationEnumTypeType(CSecurityClassificationEnumTypeType const& init);
	void operator=(CSecurityClassificationEnumTypeType const& other) { m_node = other.m_node; }
	static altova::meta::ComplexType StaticInfo() { return altova::meta::ComplexType(types + _altova_ti_t_altova_CSecurityClassificationEnumTypeType); }
...
//#endif // _ALTOVA_INCLUDED_QIFDocument_ALTOVA_t_ALTOVA_CSecurityClassificationEnumTypeType
