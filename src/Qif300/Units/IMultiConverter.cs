...
{
    /// <summary> Interfaces for unit converter from many units to one destination unit. </summary>
    interface IMultiConverter
    {
        /// <summary> Converts a value from specified unit to the destination unit. </summary>
        /// <param name="unit"> Source unit name </param>
        /// <param name="value"> Value in source unit </param>
        /// <returns> Converted value in destination unit  </returns>
        double? Convert(string unit, decimal value);
    }
}
