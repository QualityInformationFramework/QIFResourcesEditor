...
namespace altova
{
	...
	QIFBASE_EXPORT extern ValueFormatter* Exported_TimeFormatter;
	QIFBASE_EXPORT extern ValueFormatter* Exported_DateFormatter;
	QIFBASE_EXPORT extern ValueFormatter* Exported_DateTimeFormatter;
	QIFBASE_EXPORT extern ValueFormatter* Exported_GYearFormatter;
	QIFBASE_EXPORT extern ValueFormatter* Exported_GMonthFormatter;
	QIFBASE_EXPORT extern ValueFormatter* Exported_GDayFormatter;
	QIFBASE_EXPORT extern ValueFormatter* Exported_GYearMonthFormatter;
	QIFBASE_EXPORT extern ValueFormatter* Exported_GMonthDayFormatter;
	QIFBASE_EXPORT extern ValueFormatter* Exported_IntegerFormatter;
	QIFBASE_EXPORT extern ValueFormatter* Exported_DecimalFormatter;
	QIFBASE_EXPORT extern ValueFormatter* Exported_AnySimpleTypeFormatter;
	QIFBASE_EXPORT extern ValueFormatter* Exported_DurationFormatter;
	QIFBASE_EXPORT extern ValueFormatter* Exported_DoubleFormatter;
	QIFBASE_EXPORT extern ValueFormatter* Exported_Base64BinaryFormatter;
	QIFBASE_EXPORT extern ValueFormatter* Exported_HexBinaryFormatter;
